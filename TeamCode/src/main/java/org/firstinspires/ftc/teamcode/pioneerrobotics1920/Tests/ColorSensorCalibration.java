...
public class ColorSensorCalibration extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (writing) {
                if (stone)
                    ReadWriteFile.writeFile(stoneValues, getColorValues());
                else
                    ReadWriteFile.writeFile(emptyValues, getColorValues());
            }
        ...
        ReadWriteFile.writeFile(colorSensorCalibrationValue, getCenter(stoneOutPoints).toString() + "\n");
    }
